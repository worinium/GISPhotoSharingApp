using gis_photo_sharing_app.Domain.Exceptions;
using gis_photo_sharing_app.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace gis_photo_sharing_app.Domain.UnitTests.ValueObjects
{
